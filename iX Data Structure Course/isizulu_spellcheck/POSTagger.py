...
def create_model(corpus_root, train_file):
    text_tagged = TaggedCorpusReader(corpus_root, ".txt", sep= "\\")
...
"""
Given a file containing a tagging model, return that model
...
"""
Given a file with sentences in the "language", return the tagged sentences
@param {Object} model - the tagging model we use to tag
@param {string} text_path - the file containing the text to tag
"""
